...
public sealed partial class EntranceConfig :  Bright.Config.BeanBase 
{
    public EntranceConfig(JSONNode _json) 
    {
    ...
    public EntranceConfig(int ID, int sort, string entranceName, System.Collections.Generic.List<int> area ) 
    {
        this.ID = ID;
        this.Sort = sort;
    ...
    public static EntranceConfig DeserializeEntranceConfig(JSONNode _json)
    {
        return new entrance.EntranceConfig(_json);
    }
    ...
    public const int __ID__ = -1736085520;
