...
public sealed partial class LaunchPreConfig :  Bright.Config.BeanBase 
{
    ...
    public LaunchPreConfig(int ID, System.Collections.Generic.List<string> DNS, string CdnDirectoryName, string Auth, string LaunchPackageName, string LobbyPackageName, string GamePackageName, string ScriptResName, string LaunchResName, string VideoName, string Language, int platformId ) 
    {
        this.ID = ID;
        this.DNS = DNS;
